...
public class SignInFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SIGN_IN_REQ) {
            ...
            if (account != null) {
               openCalculatorFragment();
                Toast.makeText(getActivity(), "Welcome "+ account.getDisplayName(), Toast.LENGTH_LONG).show();

            }
        }
    }
    private void openCalculatorFragment(){
        // This method opens the Calculator fragment
        FragmentManager fragmentManager = getFragmentManager();
        MainFragment mainFragment = new MainFragment();
        fragmentManager.beginTransaction().replace(R.id.container_main,mainFragment).commit();
    }
}
